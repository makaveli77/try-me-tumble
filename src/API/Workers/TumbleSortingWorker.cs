...
public class TumbleSortingWorker(
    ...
    IConnectionMultiplexer redis) : BackgroundService
{
    ...
    {
        logger.LogInformation("TumbleSortingWorker starting.");
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            {
                logger.LogError(ex, "Error occurred executing TumbleSortingWorker.");
            }
    ...
    {
        logger.LogInformation("Starting background Tumble Sorting at: {time}", DateTimeOffset.Now);
        ...
        logger.LogInformation("Tumble Sorting completed successfully.");
    }
