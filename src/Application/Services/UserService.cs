...
public class UserService(IUnitOfWork unitOfWork) : IUserService
{
    ...
    {
        var saves = await unitOfWork.SavedWebsites.GetByUserIdAsync(userId, page, pageSize);
    ...
    {
        var upvotes = await unitOfWork.Upvotes.GetByUserIdAsync(userId, page, pageSize);
